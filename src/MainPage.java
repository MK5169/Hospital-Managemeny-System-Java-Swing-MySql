...
public class MainPage extends JFrame {
	...
	public MainPage() {
		...
		label_1.setBounds(49, 153, 173, 163);
		...
		lblL.setBounds(268, 153, 173, 163);
		contentPane.add(lblL);
		
		JLabel label_2 = new JLabel("");
		Image img2 =new ImageIcon(this.getClass().getResource("search.png")).getImage();
		label_2.setIcon(new ImageIcon(img2));
		label_2.setBounds(507, 153, 173, 163);
		contentPane.add(label_2);
		
		JLabel label_3 = new JLabel("");
		Image img3 =new ImageIcon(this.getClass().getResource("ptic.png")).getImage();
		label_3.setIcon(new ImageIcon(img3));
		label_3.setBounds(717, 84, 258, 248);
...
//		contentPane.add(label_4);
		...
		btnDoctor.setBounds(77, 357, 124, 23);
		...
		btnNewButton.setBounds(293, 357, 137, 23);
		...
		btnNewButton_1.setBounds(781, 357, 124, 23);
		contentPane.add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("Patient History");
		...
		btnNewButton_2.setBounds(530, 357, 137, 23);
